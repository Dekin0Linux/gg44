    ...
    return (
        <div className="my-20">
            <div className="container mx-auto" data-aos="fade-up"  data-aos-duration="3000">
                <p className="md:text-3xl text-xl font-semibold pb-5 text-sky-600 text-center">PROJECTS WE REPRESENT</p>

                <div className="grid md:grid-cols-4 grid-cols-1 gap-5 my-5 p-4 md:p-0">
